...
const{addCompany, addProducer,addDealer,getDealer} = require("../controlers/adminControlers")
...
const {addPayment, getPayment, ClientPayment,  getDepositCashPayment, Deposit, dailyReport} = require("../controlers/payments")
const {getClients, addClient} = require("../controlers/clients");
